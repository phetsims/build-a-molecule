Build a Molecule
=============
"Build a Molecule" is an educational simulation in HTML5, by <a href="https://phet.colorado.edu/" target="_blank">PhET Interactive Simulations</a>
...
(5) Open in the browser: `http://localhost/build-a-molecule/build-a-molecule_en.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
...
(3) Open in the browser: `http://localhost/build-a-molecule/build/adapted-from-phet/build-a-molecule_en_adapted-from-phet.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
