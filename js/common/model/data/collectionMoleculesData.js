...
define( require => {
  ...
  const collectionMoleculesData = [
    ...
    'borane|BH3|6331|2d|4|3|B 0 0.155|H 0.65 0.55,0-1|H -0.65 0.55,0-1|H 0 -0.665,0-1',
    ...
    'molecular fluorine|F2|24524|2d|2|1|F 0.5 0|F -0.5 0,0-1',
    'molecular hydrogen|H2|783|2d|2|1|H -0.45 0|H 0.45 0,0-1',
    ...
    'trifluoroborane|BF3|6356|2d|4|3|F 0.866 0.75|F -0.866 0.75|F 0 -0.75|B 0 0.0,0-1,1-1,2-1',
